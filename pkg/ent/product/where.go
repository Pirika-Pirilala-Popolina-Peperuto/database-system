...
// HasShoppingCartOwners applies the HasEdge predicate on the "shopping_cart_owners" edge.
func HasShoppingCartOwners() predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(ShoppingCartOwnersTable, FieldID),
...
// HasShoppingCartOwnersWith applies the HasEdge predicate on the "shopping_cart_owners" edge with a given conditions (other predicates).
func HasShoppingCartOwnersWith(preds ...predicate.User) predicate.Product {
	return predicate.Product(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
